 ...
 public class NIO {  
     ...
     public static void main(String args[]) throws Exception {  
         ...
         RandomAccessFile source = new RandomAccessFile(fin, "r");
         FileChannel fcin = source.getChannel();  
         ByteBuffer rBuffer = ByteBuffer.allocate(bufSize);  
         RandomAccessFile target = new RandomAccessFile(fout, "rws");
         FileChannel fcout = target.getChannel();  
