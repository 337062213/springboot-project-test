...
Z.declareUI('Suggest', function () {
    ...
    this.init = function (input, option) {
		...
		this.processData = option.processData || function (data) {
			return data
		}
        this.processLi = option.processLi || function (v1, v2) {
            return v1
        }
        this.processVal = option.processVal || function (v1, v2) {
            return v1
        }
        this.currLi = null
